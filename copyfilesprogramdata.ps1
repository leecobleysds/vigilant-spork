# Define variables
$sourcePath = "\\sageserver.cloudad.sdslimited.com\Sage\Installers\Sage 200 Client\manual\Program Data"  # The UNC path of the folder on the file server
$destinationPath = "C:\ProgramData"        # The local path where you want to copy the contents
